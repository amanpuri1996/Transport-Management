<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Loan-Account.aspx.cs" Inherits="Loan_Account" %>
    ...
    <div class="row tm-content-row tm-mt-big">
        <div class="box">
           ...
           Create Loan Account
            ...
            <div class="row">
                    <div class="col-md-3">
       Account Name *:   <asp:TextBox ID="txt_account_Name" runat="server" CssClass="form-control" placeholder="Name"></asp:TextBox>
      ...
      State :  <asp:DropDownList ID="ddl_state" runat="server" OnSelectedIndexChanged="ddl_state_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                ...
                <div class="col-md-3">
            District :  <asp:DropDownList ID="ddl_district" runat="server" CssClass="form-control">
             ...
             <div class="row">
                    <div class="box-body">
                        <asp:UpdatePanel ID="updt_pnl" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdvw_loan_account" runat="server" DataKeyNames="id" AutoGenerateColumns="false" CssClass="table table-striped  table-responsive" OnRowEditing="grdvw_loan_account_RowEditing">
                                    <Columns>
