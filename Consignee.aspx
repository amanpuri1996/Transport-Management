<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Consignee.aspx.cs" Inherits="Consignee" %>
    ...
    <div class="row tm-content-row tm-mt-big">
        <div class="box">
           ...
           Create Consignee
            ...
            <div class="row">
                    <div class="col-md-3">
       Consigner Name *:   <asp:TextBox ID="txt_Consignee_Name" runat="server" CssClass="form-control" placeholder="Name"></asp:TextBox>
               ...
               <div class="row">
                    <div class="box-body" style="overflow: scroll; height: 433px; width: 100%;">
                        <asp:UpdatePanel ID="updt_pnl" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdvw_consignee" runat="server" DataKeyNames="id" AutoGenerateColumns="false" CssClass="table table-striped  table-responsive" OnRowEditing="grdvw_consigner_RowEditing">
                                    <Columns>
